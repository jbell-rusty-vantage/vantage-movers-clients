...
const BOUNCE_SESSION_KEY = "vantage_main_site_bounce_session";
const BOUNCE_STARTED_AT_KEY = "vantage_main_site_bounce_started_at";
const BOUNCE_LANDING_PATH_KEY = "vantage_main_site_bounce_landing_path";
const BOUNCE_CONVERTED_KEY = "vantage_main_site_bounce_converted";
